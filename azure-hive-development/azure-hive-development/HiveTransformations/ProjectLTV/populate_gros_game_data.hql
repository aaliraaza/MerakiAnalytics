add jar wasbs://adfsources@rgdsadldev.blob.core.windows.net/hivemall-core-0.4.2-rc.2-with-dependencies.jar;
--source  wasbs://adfsources@rgdsadldev.blob.core.windows.net/define-all.hive;
...
INSERT OVERWRITE TABLE proj_ltv.game_data_gros PARTITION (groupkeydate)

SELECT 
      customerkey,
      COALESCE(kv['B_NetEntCASINO_TransferIn'],0) AS C1B_NetEntCASINO_TransferIn,
COALESCE(kv['B_MicroGamingCASINO_TransferIn'],0) AS C1B_MicroGamingCASINO_TransferIn,
COALESCE(kv['B_MicroGamingCASINO_Stake'],0) AS C1B_MicroGamingCASINO_Stake,
COALESCE(kv['B_BlueprintOTHER_TransferOut'],0) AS C1B_BlueprintOTHER_TransferOut,
COALESCE(kv['B_MicroGamingOTHER_TransferIn'],0) AS C1B_MicroGamingOTHER_TransferIn,
COALESCE(kv['B_WmsOTHER_TransferIn'],0) AS C1B_WmsOTHER_TransferIn,
COALESCE(kv['B_IGTRGSxtCASINO_TransferIn'],0) AS C1B_IGTRGSxtCASINO_TransferIn,
COALESCE(kv['B_MicroGamingCASINO_Win'],0) AS C1B_MicroGamingCASINO_Win,
COALESCE(kv['B_VirtueFusionOTHER_Win'],0) AS C1B_VirtueFusionOTHER_Win,
COALESCE(kv['B_MicrogamingPokerOTHER_Refund'],0) AS C1B_MicrogamingPokerOTHER_Refund,
COALESCE(kv['B_EyeconCASINO_Refund'],0) AS C1B_EyeconCASINO_Refund,
COALESCE(kv['B_NovomaticOTHER_Refund'],0) AS C1B_NovomaticOTHER_Refund,
COALESCE(kv['B_MicroGamingCASINO_TransferOut'],0) AS C1B_MicroGamingCASINO_TransferOut,
COALESCE(kv['B_OpenBetFOGOTHER_TransferOut'],0) AS C1B_OpenBetFOGOTHER_TransferOut,
COALESCE(kv['B_EvolutionOTHER_TransferIn'],0) AS C1B_EvolutionOTHER_TransferIn,
COALESCE(kv['B_RealisticOTHER_TransferIn'],0) AS C1B_RealisticOTHER_TransferIn,
COALESCE(kv['B_NYXOTHER_TransferIn'],0) AS C1B_NYXOTHER_TransferIn,
COALESCE(kv['B_NetEntCASINO_Stake'],0) AS C1B_NetEntCASINO_Stake,
COALESCE(kv['B_IGTRGSxtCASINO_Stake'],0) AS C1B_IGTRGSxtCASINO_Stake,
COALESCE(kv['B_RealisticCASINO_Win'],0) AS C1B_RealisticCASINO_Win,
COALESCE(kv['B_NovomaticOTHER_TransferOut'],0) AS C1B_NovomaticOTHER_TransferOut,
COALESCE(kv['B_NetEntOTHER_Stake'],0) AS C1B_NetEntOTHER_Stake,
COALESCE(kv['B_VirtueFusionOTHER_TransferIn'],0) AS C1B_VirtueFusionOTHER_TransferIn,
COALESCE(kv['B_IGTRGSxtCASINO_Win'],0) AS C1B_IGTRGSxtCASINO_Win,
COALESCE(kv['B_OpenBetFOGCASINO_TransferIn'],0) AS C1B_OpenBetFOGCASINO_TransferIn,
COALESCE(kv['B_NovomaticCASINO_Win'],0) AS C1B_NovomaticCASINO_Win,
COALESCE(kv['B_BlueprintOTHER_Stake'],0) AS C1B_BlueprintOTHER_Stake,
COALESCE(kv['B_EvolutionOTHER_Stake'],0) AS C1B_EvolutionOTHER_Stake,
COALESCE(kv['B_NovomaticCASINO_Refund'],0) AS C1B_NovomaticCASINO_Refund,
COALESCE(kv['B_VirtueFusionOTHER_Stake'],0) AS C1B_VirtueFusionOTHER_Stake,
COALESCE(kv['B_NovomaticOTHER_Stake'],0) AS C1B_NovomaticOTHER_Stake,
COALESCE(kv['B_MicroGamingCASINO_Refund'],0) AS C1B_MicroGamingCASINO_Refund,
COALESCE(kv['B_WmsCASINO_TransferOut'],0) AS C1B_WmsCASINO_TransferOut,
COALESCE(kv['B_OpenBetFOGCASINO_Win'],0) AS C1B_OpenBetFOGCASINO_Win,
COALESCE(kv['B_EvolutionOTHER_Win'],0) AS C1B_EvolutionOTHER_Win,
COALESCE(kv['B_OpenBetFOGCASINO_Refund'],0) AS C1B_OpenBetFOGCASINO_Refund,
COALESCE(kv['B_RealisticOTHER_Win'],0) AS C1B_RealisticOTHER_Win,
COALESCE(kv['B_IGTRGSxtCASINO_TransferOut'],0) AS C1B_IGTRGSxtCASINO_TransferOut,
COALESCE(kv['B_WmsCASINO_TransferIn'],0) AS C1B_WmsCASINO_TransferIn,
COALESCE(kv['B_NYXOTHER_Stake'],0) AS C1B_NYXOTHER_Stake,
COALESCE(kv['B_RealisticOTHER_TransferOut'],0) AS C1B_RealisticOTHER_TransferOut,
COALESCE(kv['B_IGTRGSxtCASINO_Refund'],0) AS C1B_IGTRGSxtCASINO_Refund,
COALESCE(kv['B_MicroGamingOTHER_Win'],0) AS C1B_MicroGamingOTHER_Win,
COALESCE(kv['B_NovomaticCASINO_Stake'],0) AS C1B_NovomaticCASINO_Stake,
COALESCE(kv['000PyramidBEDE_OTHER_Stake'],0) AS C1000PyramidBEDE_OTHER_Stake,
COALESCE(kv['B_VirtueFusionCASINO_Refund'],0) AS C1B_VirtueFusionCASINO_Refund,
COALESCE(kv['B_RealisticCASINO_TransferIn'],0) AS C1B_RealisticCASINO_TransferIn,
COALESCE(kv['B_OpenBetFOGOTHER_TransferIn'],0) AS C1B_OpenBetFOGOTHER_TransferIn,
COALESCE(kv['B_MicrogamingPokerOTHER_TransferIn'],0) AS C1B_MicrogamingPokerOTHER_TransferIn,
COALESCE(kv['000PyramidBEDE_OTHER_Win'],0) AS C1000PyramidBEDE_OTHER_Win,
COALESCE(kv['B_MicrogamingPokerOTHER_Stake'],0) AS C1B_MicrogamingPokerOTHER_Stake,
COALESCE(kv['B_OpenBetFOGCASINO_Stake'],0) AS C1B_OpenBetFOGCASINO_Stake,
COALESCE(kv['B_OpenBetFOGOTHER_Stake'],0) AS C1B_OpenBetFOGOTHER_Stake,
COALESCE(kv['B_NetEntOTHER_Refund'],0) AS C1B_NetEntOTHER_Refund,
COALESCE(kv['B_IGTRGSxtOTHER_Refund'],0) AS C1B_IGTRGSxtOTHER_Refund,
COALESCE(kv['B_WmsCASINO_Win'],0) AS C1B_WmsCASINO_Win,
COALESCE(kv['B_NYXOTHER_Win'],0) AS C1B_NYXOTHER_Win,
COALESCE(kv['B_OpenBetFOGOTHER_Refund'],0) AS C1B_OpenBetFOGOTHER_Refund,
COALESCE(kv['B_NetEntOTHER_TransferIn'],0) AS C1B_NetEntOTHER_TransferIn,
COALESCE(kv['B_NYXOTHER_Refund'],0) AS C1B_NYXOTHER_Refund,
COALESCE(kv['B_EyeconCASINO_TransferOut'],0) AS C1B_EyeconCASINO_TransferOut,
COALESCE(kv['B_IGTRGSxtOTHER_Stake'],0) AS C1B_IGTRGSxtOTHER_Stake,
COALESCE(kv['000PyramidBEDE_OTHER_TransferOut'],0) AS C1000PyramidBEDE_OTHER_TransferOut,
COALESCE(kv['B_MicrogamingPokerOTHER_TransferOut'],0) AS C1B_MicrogamingPokerOTHER_TransferOut,
COALESCE(kv['B_MicroGamingOTHER_TransferOut'],0) AS C1B_MicroGamingOTHER_TransferOut,
COALESCE(kv['B_NovomaticOTHER_Win'],0) AS C1B_NovomaticOTHER_Win,
COALESCE(kv['B_BlueprintOTHER_Win'],0) AS C1B_BlueprintOTHER_Win,
COALESCE(kv['B_NetEntOTHER_TransferOut'],0) AS C1B_NetEntOTHER_TransferOut,
COALESCE(kv['B_EyeconCASINO_Win'],0) AS C1B_EyeconCASINO_Win,
COALESCE(kv['B_NetEntCASINO_TransferOut'],0) AS C1B_NetEntCASINO_TransferOut,
COALESCE(kv['B_NetEntCASINO_Win'],0) AS C1B_NetEntCASINO_Win,
COALESCE(kv['B_IGTRGSxtOTHER_Win'],0) AS C1B_IGTRGSxtOTHER_Win,
COALESCE(kv['B_BlueprintOTHER_TransferIn'],0) AS C1B_BlueprintOTHER_TransferIn,
COALESCE(kv['B_RealisticOTHER_Stake'],0) AS C1B_RealisticOTHER_Stake,
COALESCE(kv['B_VirtueFusionCASINO_TransferOut'],0) AS C1B_VirtueFusionCASINO_TransferOut,
COALESCE(kv['B_RealisticCASINO_TransferOut'],0) AS C1B_RealisticCASINO_TransferOut,
COALESCE(kv['B_IGTRGSxtOTHER_TransferOut'],0) AS C1B_IGTRGSxtOTHER_TransferOut,
COALESCE(kv['B_NovomaticCASINO_TransferOut'],0) AS C1B_NovomaticCASINO_TransferOut,
COALESCE(kv['B_NYXOTHER_TransferOut'],0) AS C1B_NYXOTHER_TransferOut,
COALESCE(kv['B_WmsOTHER_Win'],0) AS C1B_WmsOTHER_Win,
COALESCE(kv['B_EvolutionOTHER_TransferOut'],0) AS C1B_EvolutionOTHER_TransferOut,
COALESCE(kv['B_MicroGamingOTHER_Stake'],0) AS C1B_MicroGamingOTHER_Stake,
COALESCE(kv['B_WmsCASINO_Stake'],0) AS C1B_WmsCASINO_Stake,
COALESCE(kv['000PyramidBEDE_OTHER_TransferIn'],0) AS C1000PyramidBEDE_OTHER_TransferIn,
COALESCE(kv['B_NetEntOTHER_Win'],0) AS C1B_NetEntOTHER_Win,
COALESCE(kv['B_WmsOTHER_TransferOut'],0) AS C1B_WmsOTHER_TransferOut,
COALESCE(kv['B_WmsCASINO_Refund'],0) AS C1B_WmsCASINO_Refund,
COALESCE(kv['B_RealisticCASINO_Refund'],0) AS C1B_RealisticCASINO_Refund,
COALESCE(kv['B_VirtueFusionCASINO_Win'],0) AS C1B_VirtueFusionCASINO_Win,
COALESCE(kv['B_EvolutionOTHER_Refund'],0) AS C1B_EvolutionOTHER_Refund,
COALESCE(kv['B_VirtueFusionOTHER_Refund'],0) AS C1B_VirtueFusionOTHER_Refund,
COALESCE(kv['B_EyeconCASINO_TransferIn'],0) AS C1B_EyeconCASINO_TransferIn,
COALESCE(kv['B_BlueprintOTHER_Refund'],0) AS C1B_BlueprintOTHER_Refund,
COALESCE(kv['000PyramidBEDE_OTHER_Refund'],0) AS C1000PyramidBEDE_OTHER_Refund,
COALESCE(kv['B_WmsOTHER_Refund'],0) AS C1B_WmsOTHER_Refund,
COALESCE(kv['B_NovomaticOTHER_TransferIn'],0) AS C1B_NovomaticOTHER_TransferIn,
COALESCE(kv['B_RealisticCASINO_Stake'],0) AS C1B_RealisticCASINO_Stake,
COALESCE(kv['B_MicrogamingPokerOTHER_Win'],0) AS C1B_MicrogamingPokerOTHER_Win,
COALESCE(kv['B_OpenBetFOGOTHER_Win'],0) AS C1B_OpenBetFOGOTHER_Win,
COALESCE(kv['B_VirtueFusionCASINO_Stake'],0) AS C1B_VirtueFusionCASINO_Stake,
groupkeydate
FROM
    (
    SELECT groupkeydate,customerkey,to_map(key, amountbasecurrency) kv
    FROM
        ( 
       select 
        ...
        where t1.groupkeydate >= '2016-03-01' 
		      and t1.groupkeydate < '2016-12-31'   
